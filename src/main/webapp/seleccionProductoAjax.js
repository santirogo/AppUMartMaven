        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.arreglo.length; i++) {
                ...
                $("#prueba").append(
                        ...
                        "<div  id='item' style='cursor:pointer; width:300px; overflow: hidden;'> <img style='padding:0px; margin-right: 10px; width: 150px; height: 200px' id='perfil' src=" + data.arreglo[i].ruta + "><p class='titulo_uno' id='n" + i + "'>" + data.arreglo[i].nombre + "</p><p style='float: right; margin: 0px 20px 0px 0px;' class='descripcion2' id='p" + i + "'>" + "$ " + data.arreglo[i].precio + "<input id='c"+i+"' type='text' class='pass' value='1'/><button style='border-radius:100%;  margin: 0px 0px 5px 5px; ' class='btn' onclick='cli(" + i + ")' id=" + i + ">+</button><br>" + "</div>"

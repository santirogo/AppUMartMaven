...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <center><button style="margin-top: 20px; background-color: #e30020; cursor: alias;" onclick="cerrarSesion()"><i class="fa fa-power-off"></i> Cerrar Sesion</button><a href="Calificaciones.jsp">Calificar vendedor</a></center>
            <!-- END MAIN -->
        </div>
        <script>
            filterSelection("all")

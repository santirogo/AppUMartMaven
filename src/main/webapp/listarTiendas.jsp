...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <center><button style="margin-top: 20px; background-color: #e30020; cursor: alias;" onclick="cerrarSesion()"><i class="fa fa-power-off"></i> Cerrar Sesion</button><button style="margin-top: 20px; background-color: #087eac; cursor: alias;" href="Calificaciones.jsp">Calificar vendedor</button></center>
            <!-- END MAIN -->
        </div>
        <script>
            filterSelection("all")
